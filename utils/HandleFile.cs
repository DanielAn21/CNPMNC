    ...
    public static class HandleFile
    {
        ...
        public static string UploadSingleFile(IFormFile? image)
        {
            ...
            if (image != null)
            {
                ...
                //Get url To Save
                string SavePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/files/admin", ImageName);
        ...
        {
            string SavePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/files/admin", filePath);
            try
            {
